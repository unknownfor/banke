...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.reportList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.report.list')}}</span>
            </div>
            <div class="actions">
              <div class="btn-group">
                @permission(config('admin.permissions.report.create'))
                <a href="{{url('admin/report/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <div class="col-md-3">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="title" placeholder="{{ trans('labels.report.title') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group form-md-line-input">
                        <select class="bs-select form-control form-filter" data-show-subtext="true" name="status">
                            ...
                            @if(trans('strings.report'))
                                @foreach(trans('strings.report') as $status_key => $status_value)
...
<script type="text/javascript" src="{{asset('backend/js/report/report-list.js')}}"></script>
