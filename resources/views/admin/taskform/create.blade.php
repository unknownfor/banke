...
@section('content')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('admin/taskform')}}">{!! trans('labels.breadcrumb.taskformList') !!}</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <span>{!! trans('labels.breadcrumb.taskformCreate') !!}</span>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.taskformCreate') !!}</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    ...
                    @endif
                    <form role="form" class="form-horizontal" method="POST" action="{{url('admin/taskform')}}">
                        {!! csrf_field() !!}
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                <label class="col-md-1 control-label" for="name">{{trans('labels.taskform.name')}}</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="{{trans('labels.taskform.name')}}" value="{{old('name')}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>

                            <div class="form-group form-md-line-input">
                                <label class="col-md-1 control-label" for="seq_no">{{trans('labels.taskform.seq_no')}}(数字)</label>
                                <div class="col-md-5">
                                    <input type="number" class="form-control" id="seq_no" name="seq_no" placeholder="{{trans('labels.taskform.seq_no')}}" value="{{old('seq_no')}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" id="user_type1" name="user_type" value="1" class="md-radiobtn" checked>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                        <input type="text" class="form-control input-sm" readonly placeholder="结束时间" name="time_end">
