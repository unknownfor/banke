...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.goodarticleList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.goodarticle.list')}}</span>
            </div>
            <div class="actions">
              <div class="btn-group">
                @permission(config('admin.permissions.goodarticle.create'))
                <a href="{{url('admin/goodarticle/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th>#</th>
                          <th width="30%"> {{ trans('labels.goodarticle.title') }} </th>
                          <th width="30%"> {{ trans('labels.goodarticle.url') }} </th>
                          <th width="15%"> {{ trans('labels.goodarticle.status') }} </th>
                          <th width="15%"> {{ trans('labels.goodarticle.created_at') }} </th>
...
<script type="text/javascript" src="{{asset('backend/js/goodarticle/list.js')}}"></script>
