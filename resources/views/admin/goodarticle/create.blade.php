...
@section('content')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('admin/goodarticle')}}">{!! trans('labels.breadcrumb.goodarticleList') !!}</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                <span>{!! trans('labels.breadcrumb.goodarticleCreate') !!}</span>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.goodarticleCreate') !!}</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    ...
                    @endif
                    <form role="form" class="form-horizontal" method="POST" action="{{url('admin/goodarticle')}}">
                        {!! csrf_field() !!}
                        <div class="form-body">

                            <div class="form-group form-md-line-input">
                                <label class="col-md-1 control-label" for="slug">选择</label>
                                <div class="col-md-8">
                                    <select id="user-type-select" name="strategy_id" class="selectpicker show-tick form-control" data-live-search="true">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-1 col-md-10">
                                    <a href="{{url('admin/goodarticle')}}" class="btn default">{{trans('crud.cancel')}}</a>
...
@section('js')
    ...
    <script type="text/javascript" src="{{asset('backend/js/goodarticle/index.js')}}"></script>
@endsection