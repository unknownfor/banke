                ...
                <div class="col-md-2">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="mobile" placeholder="{{ trans('labels.invitation.mobile') }}">
                ...
                <div class="col-md-2">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="target_mobile" placeholder="{{ trans('labels.invitation.target_mobile') }}">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                              ...
                              <th width="10%"> {{ trans('labels.invitation.enrol_status') }} </th>
                        </tr>
                    </thead>
                    <tbody> </tbody>
                </table>
