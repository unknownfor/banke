                ...
                <div class="col-md-2">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="uname" placeholder="{{ trans('labels.invitation.uname') }}">
                ...
                <div class="col-md-2">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="target_uname" placeholder="{{ trans('labels.invitation.target_uname') }}">
                            <div class="form-control-focus"> </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                              ...
                              <th width="10%"> {{ trans('labels.invitation.target_uname') }} </th>
                              <th width="20%"> {{ trans('labels.invitation.register_time') }} </th>
                              <th width="20%"> {{ trans('labels.invitation.isCheck') }} </th>
                              <th width="15%"> {{ trans('labels.invitation.isEnroll') }} </th>
