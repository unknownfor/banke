              ...
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/activity/'.$activity['id'])}}">
                  ...
                  <div class="form-body">
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <span class="label label-success"> 普通外链</span>
                          </div>
                      </div>
                      <div class="form-group form-md-line-input">
                      ...
                      <div class="form-group form-md-line-input form-md-line-cover">
                          ...
                          <div class="col-md-9">
                              <div class="cover-box">
                                  <div class="add-img-btn add-content-img-btn-outlink-normal">+
...
<form id="upImgForm1" method="post" class="hiddenForm">
    <input type="file" name="filedata" class="dataImportFileInput1" id="uploadImgFile1" size="28" accept="image/png,image/gif,image/jpeg">
</form>
<form id="upImgForm2" method="post" class="hiddenForm">
    <input type="file" name="filedata" class="dataImportFileInput2" id="uploadImgFile2" size="28" accept="image/png,image/gif,image/jpeg">
</form>
