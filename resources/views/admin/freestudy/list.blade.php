...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.freestudyList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.freestudy.list')}}</span>
            </div>
            <div class="actions">
              <div class="btn-group">
                @permission(config('admin.permissions.freestudy.create'))
                <a href="{{url('admin/freestudy/create')}}" class="btn btn-success btn-outline btn-circle">
...
@section('js')
    ...
    <script type="text/javascript" src="{{asset('backend/js/freestudy/list.js')}}"></script>
