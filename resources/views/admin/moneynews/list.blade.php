...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.moneynewsList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.moneynews.list')}}</span>
            </div>
            <div class="actions">
              <div class="btn-group">
                @permission(config('admin.permissions.moneynews.create'))
                <a href="{{url('admin/moneynews/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th>#</th>
                          <th width="18%"> {{ trans('labels.moneynews.user_name') }} </th>
                          <th> {{ trans('labels.moneynews.business_type') }} </th>
                          <th> {{ trans('labels.moneynews.amount') }} </th>
                          <th> {{ trans('labels.moneynews.from') }} </th>
                          <th> {{ trans('labels.moneynews.status') }} </th>
                          <th width="15%"> {{ trans('labels.moneynews.created_at') }} </th>
...
<script type="text/javascript" src="{{asset('backend/js/moneynews/list.js')}}"></script>
