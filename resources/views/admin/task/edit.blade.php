      ...
      <div class="portlet light bordered">
          <div class="portlet-title">
              <div class="caption font-green-haze">
                  ...
                  <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.taskEdit') !!}</span>
              </div>
              <div class="actions">
          ...
          <div class="portlet-body form">
          		@if (isset($errors) && count($errors) > 0 )
					    ...
					    @endif
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/task/'.$task['id'])}}">
              		{!! csrf_field() !!}
                  ...
                  <div class="form-group form-md-line-input">
                      ...
                      <div class="col-md-8">
                          <input type="text" class="form-control" id="name" name="name" placeholder="{{trans('labels.task.name')}}" value="{{$task['name']}}">
...
@section('js')
    ...
    <script type="text/javascript" src="{{asset('backend/js/task/edit.js')}}"></script>
@endsection