...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.certificationList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.app_user.certification')}}</span>
            </div>
            {{--<div class="actions">
              <div class="btn-group">
                            ...
                            <td>
                              <div class="form-group form-md-line-input">
                                <div class="input-group has-success">
                                    ...
                                    <input type="text" class="form-control form-filter" name="name" placeholder="{{ trans('labels.app_user.real_name') }}">
                            ...
                            <td>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control form-filter" name="school" placeholder="{{ trans('labels.app_user.school') }}">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="form-group form-md-line-input">
                                    ...
                                    <span class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control form-filter" name="major" placeholder="{{ trans('labels.app_user.major') }}">
                                        <div class="form-control-focus"> </div>
                                    </div>
                                </div>
                            </td>
                                    ...
                                    <select class="bs-select form-control form-filter" data-show-subtext="true" name="certification_status">
                                        ...
                                        @if(trans('strings.app_user'))
                                            @foreach(trans('strings.app_user') as $status_key => $status_value)
                                                @if($status_value[1]=='已认证' || $status_value[1]=='待审核')
