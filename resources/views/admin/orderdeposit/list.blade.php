...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.orderdepositList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            ...
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.orderdeposit.list')}}</span>
            </div>
          </div>
            <div class="search-box filter">
                <div class="col-md-2">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="mobile" placeholder="{{ trans('labels.orderdeposit.mobile') }}">
                ...
                <div class="col-md-2">
                    <div class="form-group form-md-line-input">
                        <select class="bs-select form-control form-filter" data-show-subtext="true" name="pay_status">
                            <option value="" data-icon="fa-glass icon-success">状态....</option>
                            @if(trans('strings.orderdeposit'))
                                @foreach(trans('strings.orderdeposit') as $status_key => $status_value)
                ...
                <div class="col-md-5">
                    <div class="col-md-2" style="display: flex;height: 65px;align-items: center">
                        <label>{{ trans('labels.orderdeposit.created_at') }}</label>
                    </div>
                    <div class="col-md-8">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                              <th>id</th>
                              <th width="10%"> {{ trans('labels.orderdeposit.name') }} </th>
                              <th width="10%"> {{ trans('labels.orderdeposit.mobile') }} </th>
                              <th width="20%"> {{ trans('labels.orderdeposit.course_name') }} </th>
                              <th width="10%"> {{ trans('labels.orderdeposit.account') }} </th>
                              <th width="10%"> {{ trans('labels.orderdeposit.pay_type') }} </th>
                              <th width="10%"> {{ trans('labels.orderdeposit.pay_status') }} </th>
                              <th width="10%"> {{ trans('labels.orderdeposit.created_at') }} </th>
...
<script type="text/javascript" src="{{asset('backend/js/orderdeposit/orderdeposit-list.js')}}"></script>
