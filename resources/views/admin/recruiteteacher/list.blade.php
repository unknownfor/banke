...
@section('content')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{!! trans('labels.recruiteteacher.list') !!}</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">{{trans('labels.recruiteteacher.list')}}</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            @permission(config('admin.permissions.recruiteteacher.create'))
                            <a href="{{url('admin/recruiteteacher/create')}}" class="btn btn-success btn-outline btn-circle">
...
@section('js')
    ...
    <script type="text/javascript" src="{{asset('backend/js/recruiteteacher/list.js')}}"></script>
