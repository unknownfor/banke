...
<div class="page-bar">
	<ul class="page-breadcrumb">
	    ...
	    <li>
	        <a href="{{url('admin/banner')}}">{!! trans('labels.breadcrumb.teachingteacherList') !!}</a>
	        <i class="fa fa-angle-right"></i>
	    </li>
	    <li>
	        <span>{!! trans('labels.breadcrumb.teachingteacherEdit') !!}</span>
	    </li>
	</ul>
</div>
      ...
      <div class="portlet light bordered">
          <div class="portlet-title">
              <div class="caption font-green-haze">
                  ...
                  <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.teachingteacherEdit') !!}</span>
              </div>
              <div class="actions">
          ...
          <div class="portlet-body form">
          		@if (isset($errors) && count($errors) > 0 )
					    ...
					    @endif
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/teachingteacher/'.$teachingteacher['id'])}}">
              		{!! csrf_field() !!}
                  <input type="hidden" name="_method" value="PATCH">
                  <input type="hidden" name="id" value="{{$teachingteacher['id']}}">
                  <div class="form-body">
                      <div class="form-group form-md-line-input form-md-line-logo">
                          <div class="col-md-1 col-md-avatar">
                              <img src="{{$teachingteacher['avatar']}}" class="img-circle" id="logo"/>
                          </div>
                          ...
                          <input type="hidden" value="$teachingteacher['avatar']" name="avatar" id="logo-input">
                      </div>

                      <div class="form-group form-md-line-input">
                          <label class="col-md-1 control-label" for="name">{{trans('labels.teachingteacher.name')}}</label>
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="name" name="name" placeholder="{{trans('labels.teachingteacher.name')}}" value="{{$teachingteacher['name']}}">
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-4">
                              <select name="org_id" class="org-selectpicker show-tick form-control" data-live-search="true">
                                  @if($orgs)
                                      @foreach($orgs as $org)
                                          <option value="{{$org->id}}" @if($teachingteacher['org_id']==$org->id) selected @endif> {{$org->name}}</option>
                                      @endforeach
                                  @endif
                              </select>
                          </div>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-4">
                              <select data-id="{{$teachingteacher['sub_org_id']}}"  name="sub_org_id" class="sub-org-selectpicker show-tick form-control" id="sub_org_id" data-live-search="true">
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-7">
                              ...
                              <input type="hidden" name="goodat_course" id="goodat-course" value="{{$teachingteacher['goodat_course']}}">
                          </div>
                      </div>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-7">
                              <div id="tags-box"></div>
                              <input type="hidden" name="tags" id="tags" value="{{$teachingteacher['tags']}}">
                          </div>
                      </div>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-9">
                              <textarea style="display: none" name="intro" id="intro-content-area">{{$teachingteacher['intro']}}</textarea>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="sort" name="sort" placeholder="{{trans('labels.teachingteacher.sort')}}" value="{{$teachingteacher['sort']}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
                          ...
                          <div class="col-md-11">
                              <div class="cover-box">
                                  ...
                                  <ul class="imgs-list-box album-list-box">
                                      @if($teachingteacher['album'])
                                          <?php
                                            $arr=explode(',',$teachingteacher['album']);
                                          ?>
                                          @foreach($arr as $v)
                                              <li>
                                                  <a href="{{$v}}" data-size="435x263"></a>
                                                  <img src="{{$v}}@142w_80h_1e">
                                                  <span class="remove-img">×</span>
                                              </li>
                                          @endforeach
                                      @endif
                                  </ul>
                                  <input type="hidden" value="{{$teachingteacher['album']}}" name="album" id="album">
                              </div>
                          </div>
                      </div>
                      <div class="form-group form-md-line-input">
                        ...
                        <div class="col-md-10">
                            <div class="md-radio-inline">
                                <div class="md-radio">
                                    <input type="radio" id="status1" name="status" value="{{config('admin.global.status.active')}}" class="md-radiobtn" @if($teachingteacher['status'] == config('admin.global.status.active')) checked @endif>
                                    <label for="status1">
                                        <span></span>
                                ...
                                <div class="md-radio">
                                    <input type="radio" id="status2" name="status" value="{{config('admin.global.status.audit')}}" class="md-radiobtn" @if($teachingteacher['status'] == config('admin.global.status.audit')) checked @endif>
                                    <label for="status2">
                                        <span></span>
                                        <span class="check"></span>
                                ...
                                <div class="md-radio">
                                    <input type="radio" id="status3" name="status" value="{{config('admin.global.status.trash')}}" class="md-radiobtn" @if($teachingteacher['status'] == config('admin.global.status.trash')) checked @endif>
                                    <label for="status3">
                                        <span></span>
                                        <span class="check"></span>
