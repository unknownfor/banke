...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.bannerList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th>#</th>
                          <th width="15%"> {{ trans('labels.banner.title') }} </th>
                          <th> {{ trans('labels.banner.img_url') }} </th>
                          <th> {{ trans('labels.banner.url') }} </th>
                          <th> {{ trans('labels.banner.sort') }} </th>
                          <th> {{ trans('labels.banner.status') }} </th>
                          <th width="15%"> {{ trans('labels.banner.created_at') }} </th>
                          <th width="15%"> {{ trans('labels.banner.updated_at') }} </th>
