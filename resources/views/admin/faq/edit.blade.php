                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                    <div class="md-radio-inline">
                                        <div class="md-radio">
                                            <input type="radio" id="status4" name="type" value="0" class="md-radiobtn" @if($faq['type'] == 0) checked @endif>
                                            <label for="status4">
                                                <span></span>
                                        ...
                                        <div class="md-radio">
                                            <input type="radio" id="status5" name="type" value="1" class="md-radiobtn" @if($faq['type'] == 1) checked @endif>
                                            <label for="status5">
                                                <span></span>
                                                <span class="check"></span>
