...
<div class="page-bar">
	<ul class="page-breadcrumb">
	    ...
	    <li>
	        <span>{!! trans('labels.breadcrumb.feedbackShow') !!}</span>
	    </li>
	</ul>
</div>
      ...
      <div class="portlet light bordered">
          <div class="portlet-title">
              <div class="caption font-green-haze">
                  ...
                  <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.feedbackShow') !!}</span>
              </div>
              <div class="actions">
                  ...
                  <div class="form-actions">
                      <div class="row">
                          <div class="col-md-offset-1 col-md-10">
                              <a href="{{url('admin/feedback')}}" class="btn default">{{trans('crud.back')}}</a>
                          </div>
                      </div>
                  </div>
              </form>
