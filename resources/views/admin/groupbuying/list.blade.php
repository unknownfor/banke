...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.groupbuyingList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            ...
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.groupbuying.list')}}</span>
            </div>
          </div>
                ...
                <div class="col-md-2">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="mobile" placeholder="{{ trans('labels.groupbuying.organizer_mobile') }}">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                            <th>id</th>
                            <th width="10%"> {{ trans('labels.groupbuying.organizer_name') }} </th>
                            <th width="10%"> {{ trans('labels.groupbuying.organizer_mobile') }} </th>
                            <th width="15%"> {{ trans('labels.groupbuying.course_name') }} </th>
                            <th width="15%"> {{ trans('labels.groupbuying.view_counts') }} </th>
                            <th width="15%"> {{ trans('labels.groupbuying.member_counts') }} </th>
                            <th width="8%"> {{ trans('labels.groupbuying.view_counts_flag') }} </th>
                            <th width="15%"> {{ trans('labels.groupbuying.updated_at') }} </th>
...
<script type="text/javascript" src="{{asset('backend/js/groupbuying/groupbuying-list.js')}}"></script>
