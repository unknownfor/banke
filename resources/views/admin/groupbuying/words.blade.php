...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.groupbuyingwordsList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            ...
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.groupbuyingwords.list')}}</span>
            </div>
            <div class="actions">
                <div class="btn-group">
                    @permission(config('admin.permissions.groupbuyingwords.create'))
                    <a href="{{url('admin/groupbuyingwords/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                            <th>id</th>
                            <th width="20%"> {{ trans('labels.groupbuyingwords.desc') }} </th>
                            <th width="20%"> {{ trans('labels.groupbuyingwords.img_url_app') }} </th>
                            <th width="20%"> {{ trans('labels.groupbuyingwords.img_url_web') }} </th>
                            <th width="15%"> {{ trans('labels.groupbuyingwords.updated_at') }} </th>
                            <th width="10%"> {{ trans('labels.groupbuyingwords.status') }} </th>
                            <th width="12%"> {{ trans('labels.action') }} </th>
                        </tr>
                    </thead>
                    <tbody> </tbody>
                </table>
...
<script type="text/javascript" src="{{asset('backend/js/groupbuying/words-list.js')}}"></script>
