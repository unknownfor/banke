...
@section('content')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('admin/news')}}">{!! trans('labels.breadcrumb.moneystrategyList') !!}</a>
                <i class="fa fa-angle-right"></i>
            </li>
            <li>
                ...
                <div class="portlet-body form">
                    ...
                    <form role="form" class="form-horizontal" method="POST" action="{{url('admin/moneystrategy')}}">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group form-md-line-input">
                                <label class="col-md-1 control-label" for="org_name">{{trans('labels.moneystrategy.type')}}</label>
                                <div class="col-md-4">
                                    <select name="type" class="selectpicker show-tick form-control" data-live-search="true">
                                        @foreach(trans('strings.moneystrategy_user_type') as $status_key => $status_value)
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="author" name="author" placeholder="{{trans('labels.moneystrategy.author')}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
