...
<div class="page-bar">
	<ul class="page-breadcrumb">
	    ...
	    <li>
	        <span>{!! trans('labels.breadcrumb.appUpdateEdit') !!}</span>
	    </li>
	</ul>
</div>
      ...
      <div class="portlet light bordered">
          <div class="portlet-title">
              <div class="caption font-green-haze">
                  ...
                  <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.appUpdateEdit') !!}</span>
              </div>
              <div class="actions">
          ...
          <div class="portlet-body form">
          		@if (isset($errors) && count($errors) > 0 )
					    ...
					    @endif
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/appUpdate/'.$appUpdate['id'])}}">
              		{!! csrf_field() !!}
                  ...
                  <div class="form-body">
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              ...
                              <textarea id="content-origin" name="instruction" placeholder="{{trans('labels.appUpdate.instruction')}}">{{$appUpdate['instruction']}}</textarea>
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group form-md-line-input">
                        <label class="col-md-2 control-label" for="form_control_1">{{trans('labels.appUpdate.status')}}</label>
                        <div class="col-md-10">
                            <div class="md-radio-inline">
                                ...
                                <div class="md-radio">
                                    ...
                                    <label for="status3">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box"></span> {{trans('strings.appUpdate.trash.1')}} </label>
                                </div>
                            </div>
                        </div>
                      </div>
