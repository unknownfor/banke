...
<div class="page-bar">
	<ul class="page-breadcrumb">
	    ...
	    <li>
	        <span>{!! trans('labels.breadcrumb.appUpdateCreate') !!}</span>
	    </li>
	</ul>
</div>
      ...
      <div class="portlet light bordered">
          <div class="portlet-title">
              <div class="caption font-green-haze">
                  ...
                  <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.appUpdateCreate') !!}</span>
              </div>
              <div class="actions">
          ...
          <div class="portlet-body form">
          		@if (isset($errors) && count($errors) > 0 )
					    ...
					    @endif
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/appUpdate')}}">
              		{!! csrf_field() !!}
                  <div class="form-body">
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="description" name="url" placeholder="{{trans('labels.appUpdate.url')}}" value="{{old('url')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
