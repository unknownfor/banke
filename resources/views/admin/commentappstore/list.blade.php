...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.commentappstoreList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.commentappstore.list')}}</span>
            </div>
            <div class="actions">
              <div class="btn-group">
                @permission(config('admin.permissions.commentappstore.create'))
                <a href="{{url('admin/commentappstore/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <div class="col-md-3">
                    <div class="form-group form-md-line-input">
                        <select class="bs-select form-control form-filter" data-show-subtext="true" name="status">
                            <option value="" data-icon="fa-glass icon-success">审校状态....</option>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                          <th>#</th>
                          <th> {{ trans('labels.commentappstore.mobile') }} </th>
                          <th> {{ trans('labels.commentappstore.comment_img') }} </th>
                          <th> {{ trans('labels.commentappstore.certificatoin_status') }} </th>
                          <th width="15%"> {{ trans('labels.commentappstore.created_at') }} </th>
...
<script type="text/javascript" src="{{asset('backend/js/commentappstore/list.js')}}"></script>
