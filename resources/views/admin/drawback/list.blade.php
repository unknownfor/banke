...
<div class="page-bar">
  <ul class="page-breadcrumb">
      ...
      <li>
          <span>{!! trans('labels.breadcrumb.drawbackList') !!}</span>
      </li>
  </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.drawback.list')}}</span>
            </div>
            <div class="actions">
              <div class="btn-group">
                @permission(config('admin.permissions.drawback.create'))
                <a href="{{url('admin/drawback/create')}}" class="btn btn-success btn-outline btn-circle">
                ...
                <div class="col-md-3">
                    <div class="form-group form-md-line-input">
                        <div class="input-group has-success">
                            ...
                            <input type="text" class="form-control form-filter" name="student_mobile" placeholder="{{ trans('labels.drawback.student_mobile') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group form-md-line-input">
                        <select class="bs-select form-control form-filter" data-show-subtext="true" name="status">
                            ...
                            @if(trans('strings.drawback'))
                                @foreach(trans('strings.drawback') as $status_key => $status_value)
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    <thead>
                        <tr role="row" class="heading">
                            <th>#</th>
                            <th width="10%"> {{ trans('labels.drawback.student_mobile') }} </th>
                            <th width="32%"> {{ trans('labels.drawback.course_name') }} </th>
                            <th width="10%"> {{ trans('labels.drawback.account') }} </th>
                            <th width="15%"> {{ trans('labels.drawback.updated_at') }} </th>
                            <th width="10%"> {{ trans('labels.drawback.operator_name') }} </th>
                            <th width="10%"> {{ trans('labels.drawback.status') }} </th>
...
<script type="text/javascript" src="{{asset('backend/js/drawback/drawback-list.js')}}"></script>
