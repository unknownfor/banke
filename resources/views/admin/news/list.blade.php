        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
          <div class="portlet-title">
            <div class="caption">
              ...
              <span class="caption-subject font-dark sbold uppercase">{{trans('labels.news.list')}}</span>
            </div>
            <div class="actions">
              <div class="btn-group">
                @permission(config('admin.permissions.news.create'))
                <a href="{{url('admin/news/create')}}" class="btn btn-success btn-outline btn-circle">
                            ...
                            <td>
                              <div class="form-group form-md-line-input">
                                <div class="input-group has-success">
                                    ...
                                    <input type="text" class="form-control form-filter" name="title" placeholder="{{ trans('labels.news.title') }}">
                              ...
                              <div class="form-group form-md-line-input">
                                <select class="bs-select form-control form-filter" data-show-subtext="true" name="status">
                                  <option value="" data-icon="fa-glass icon-success">状态....</option>
                                    @if(trans('strings.news'))
                                      @foreach(trans('strings.news') as $status_key => $status_value)
...
<script type="text/javascript" src="{{asset('backend/js/news/news-list.js')}}"></script>
