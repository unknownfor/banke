...
<head>
	...
	<link type="text/css" href="/front/assets/css/rule/v1.7/rule.css" rel="stylesheet">
	<title>首页规则</title>
</head>
<body>
<div id="rule">
	...
	<div class="content payback">
		...
		<div class="payback-box">
			<div class="payback-detail">
				<div class="payback-title">每日签到</div>
				<div class="payback-info">
					缴纳学费后，每日在半课APP首页签到领取当日返现，直至学习结束当天，签到奖励金额领取完毕。
				</div>
			</div>
			<div class="payback-detail">
